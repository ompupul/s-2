...
const Home = () => {
      ...
      <div className='bg-pure-greys-5 text-richblack-700'>
              <div className='homepage_bg h-[200px] lg:h-[310px]'>
                {/* Explore Full Catagory Section */}
                  <div className="mx-auto flex w-[80%] lg:w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
                      <div></div>
  ...
  <div className="mb-10 mt-[-50px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
      <div className='lg:text-4xl text-lg font-semibold lg:w-[45%]'>
          Get the Skills you need for a{" "}
          <HighlightText text={"Job that is in demand"} />
      </div>
  
      <div className='flex flex-col lg:gap-10 gap-5 lg:w-[40%] items-start'>
      <div className='lg:text-[16px] text-xs'>
